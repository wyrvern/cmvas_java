...
/**
 * The class <code>Encoder7Bit</code> provides a way to verifing that data fits the
 * rules so that it can be transmitted using the MIME 7Bit encoding
 * standard.
 * <p>
 * The <code>Encoder7Bit</code> does not actually do any
 * encoding, but rather checks that the provided data obays the rules.
 * <ul>
 * <li> All the characters are from the <code>us-ascii</code>
 * characteset, and therefore have a value of less than or equal
 * to 127.</li>
 ...
 * @since 1.0
 */
public class Encoder7Bit extends Encoder
{

    /**
     * Creates a new Encoder7Bit object.
     */
    public Encoder7Bit()
    {
        super();
     ...
     */
    public Encoder7Bit(byte[] p_data)
    {
        super(p_data);
    }
     ...
     * p_data data to be encoded or decoded.
     */
    public Encoder7Bit(String p_data)
    {
        super(p_data);
    }
    ...
    public String encode() throws EncodingException
    {
        ...
        {
            /* Check that none of the data elements have a value of over
            127, as this means the 8'th bit is set. */
            if(i_data[i] > 0)
            {
