...
// Dual interface FolderItem2
/** @com.interface(iid=EDC817AA-92B8-11D1-B075-00C04FC33AA5, thread=NO, type=DUAL) */
public interface FolderItem2 extends shell32.FolderItem
{
  ...
  /** @com.method(vtoffset=21, dispid=1610809344, type=METHOD, name="InvokeVerbEx", addFlagsVtable=4)
  ...
  /** @com.method(vtoffset=22, dispid=1610809345, type=METHOD, name="ExtendedProperty", addFlagsVtable=4)
      @com.parameters([in,type=STRING] bstrPropName, [type=VARIANT] return) */
  public com.ms.com.Variant ExtendedProperty(java.lang.String bstrPropName);


  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0xedc817aa, (short)0x92b8, (short)0x11d1, (byte)0xb0, (byte)0x75, (byte)0x0, (byte)0xc0, (byte)0x4f, (byte)0xc3, (byte)0x3a, (byte)0xa5);
}
