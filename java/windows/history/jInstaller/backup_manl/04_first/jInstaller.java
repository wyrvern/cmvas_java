...
//
 ...
 private int     debugState       = -1;
  ...
  private void initForm()
  {
	  ...
	  lblPackageName.setFont(new Font("Trebuchet MS", 10.0f, FontSize.POINTS, FontWeight.BOLD, false, false, false, CharacterSet.DEFAULT, 0));
	  lblPackageName.setSize(new Point(240, 16));
	  lblPackageName.setTabIndex(4);
	  lblPackageName.setTabStop(false);
	  lblPackageName.setText("");
	  lblPackageName.setTextAlign(HorizontalAlignment.CENTER);

	  lblCompany.setFont(new Font("Trebuchet MS", 10.0f, FontSize.POINTS, FontWeight.NORMAL, false, false, false, CharacterSet.DEFAULT, 0));
	  ...
	  lblHead.setFont(new Font("Trebuchet MS", 10.0f, FontSize.POINTS, FontWeight.BOLD, false, false, false));
	  lblHead.setLocation(new Point(0, 56));
