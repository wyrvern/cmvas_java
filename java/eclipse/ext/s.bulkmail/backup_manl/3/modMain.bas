...
If frmMail.grdMain.Rows > 2 Then
   ...
   If iProgress = frmMail.Progress.Max Then
      frmMail.Progress.value = 0
      frmMail.StatusBar.Panels(1).Text = iProgress & "/" & frmMail.Progress.Max & ": Checked"
   End If
   '---------------Progress
...
DataVar = "a" & DataVar
Else
frmAssist.txtArb.Text = frmAssist.txtArb.Text + 1
DataVar = DataVar & "a"
End If
...
frmAssist.a.Text = array_no
frmAssist.b.Text = array_len
frmAssist.c.Text = line_length
frmAssist.d.Text = line_number
frmAssist.e.Text = line_current
frmAssist.f.Text = cursor_pos
