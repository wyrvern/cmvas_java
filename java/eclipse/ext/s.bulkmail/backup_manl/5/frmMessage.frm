...
'For i = 1 To 2
   ...
   "<a href='http://www.isotop.net/isotop-execute/flags.aspx?a=2&e=" & frmMail.grdMain.TextMatrix(i, 2) & "'>here</a>" & vbCrLf

   htmlRequest = vbCrLf & vbCrLf & _
   "If you wish to receive your next 'isotop' email in color (html) please click " & vbCrLf & _
   "http://www.isotop.net/isotop-execute/flags.aspx?a=1&e=" & frmMail.grdMain.TextMatrix(i, 2)

   htmlFooter = "<br>" & _
   "To unsubscribe from this email list click <a href='http://www.isotop.net/isotop-execute/flags.aspx?a=0&e=" & frmMail.grdMain.TextMatrix(i, 2) & "'>here</a>"

   txtFooter = vbCrLf & _
   "To unsubscribe from this email list click" & vbCrLf & "http://www.isotop.net/isotop-execute/flags.aspx?a=0&e=" & frmMail.grdMain.TextMatrix(i, 2)
...
Mailer.FromAddress = send_from
   If debugMode = 0 Then
      Mailer.AddRecipient frmMail.grdMain.TextMatrix(i, 2), frmMail.grdMain.TextMatrix(i, 2)
   ElseIf debugMode = 1 Then
