...
ElseIf db_selection = 1 Then
   ...
   c = Array("All", "Name", "Email", "Company", "Fax", "Phone", "Zip", "State", "Country", "s_dl_q1", "s_dl_q2", "s_dl_q3", "s_dl_bin")
ElseIf db_selection = 2 Then
...
ElseIf db_selection = 2 Then
   With frmMail.grdMain
      .Clear
      .Rows = 2
      .FormatString = "<ID |<Section |<Email |<Name |<Company |<City |<Country |<Phone |<Date |<Flags "
      .ColWidth(0) = 1000
      .ColWidth(1) = 1500
      .ColWidth(2) = 1500
      .ColWidth(3) = 1500
