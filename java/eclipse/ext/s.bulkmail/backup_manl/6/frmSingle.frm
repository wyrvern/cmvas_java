...
Dim htmlRequest As String
   ...
   If db_selection = 1 Then
      ...
      "<a href='http://unsubscribe.isotop.net/?a=2&e=" & txtEmail.Text & "'>here</a>" & vbCrLf

      htmlRequest = vbCrLf & _
      "If you wish to receive your next 'isotop' email in color (html) please click " & vbCrLf & _
      "http://unsubscribe.isotop.net/?a=1&e=" & txtEmail.Text
   ...
   htmlFooter = "<br><br>" & _
   "To unsubscribe from this email list click <a href='http://unsubscribe.isotop.net/?a=0&e=" & txtEmail.Text & "'>here</a>"

   txtFooter = vbCrLf & vbCrLf & _
   "To unsubscribe from this email list click" & vbCrLf & "http://unsubscribe.isotop.net/?a=0&e=" & txtEmail.Text
