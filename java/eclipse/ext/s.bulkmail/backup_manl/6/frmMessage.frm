...
'For i = 1 To 2
   ...
   If Len(frmMail.grdMain.TextMatrix(i, 2)) < 1 Or _
      InStr(frmMail.grdMain.TextMatrix(i, 2), "@") = 0 Or _
   ...
   If db_selection = 1 Then
      ...
      "<a href='http://unsubscribe.isotop.net/?a=2&e=" & frmMail.grdMain.TextMatrix(i, 2) & "'>here</a>" & vbCrLf

      htmlRequest = vbCrLf & _
      "If you wish to receive your next 'isotop' email in color (html) please click " & vbCrLf & _
      "http://unsubscribe.isotop.net/?a=1&e=" & frmMail.grdMain.TextMatrix(i, 2)
   ...
   End If
      ...
      htmlFooter = "<br><br>" & _
      "To unsubscribe from this email list click <a href='http://unsubscribe.isotop.net/?a=0&e=" & frmMail.grdMain.TextMatrix(i, 2) & "'>here</a>"

      txtFooter = vbCrLf & vbCrLf & _
      "To unsubscribe from this email list click" & vbCrLf & "http://unsubscribe.isotop.net/?a=0&e=" & frmMail.grdMain.TextMatrix(i, 2)
...
Mailer.FromAddress = send_from
   If debugMode = 0 Then
      Mailer.AddRecipient frmMail.grdMain.TextMatrix(i, 1), frmMail.grdMain.TextMatrix(i, 2)
   ElseIf debugMode = 1 Then
      Mailer.AddRecipient frmMail.grdMain.TextMatrix(i, 1), "null@null"
   End If
