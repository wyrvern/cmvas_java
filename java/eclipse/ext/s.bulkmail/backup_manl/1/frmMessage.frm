...
"To unsubscribe from this email list click http://www.isotop.net/isotop-execute/flags.aspx?a=0&e=" & frmMail.grdMain.TextMatrix(i, 1)
...
"If you wish to receive your next 'isotop' email in color (html) please click " & _
...
frmAssist.txtYpos.Text = yPos
frmAssist.txtXpos.Text = xPos
