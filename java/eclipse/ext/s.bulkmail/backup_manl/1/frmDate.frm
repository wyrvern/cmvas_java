...
Private Sub cmdAdd_Click() 
   ...
   dbFieldID = ( "OrderID,DnID,RrID,RcID,PrID,SsID,AssessID" )
   ...
   if fieldselect     = "Orders" then
      sql = "SELECT * FROM " & fieldselect & " WHERE ApprovalCode = '" & "AP/AP/Approved" & "'"
...
rsconn = "SELECT * FROM " & Replace(cmbTable.Text, " ", "") & " WHERE ApprovalCode = '" & "AP/AP/Approved" & "'"
...
If cmbTable.Text = "Orders" Then
Call MouseChange("frmMail", "Wait")
rsconn = "SELECT * FROM Orders WHERE ApprovalCode = '" & "AP/AP/Approved" & "'"
Set rs = conn.Execute(rsconn)
