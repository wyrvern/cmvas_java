...
public class c_icmp {
   ...
   static class c_target {

      InetSocketAddress l_address;
      SocketChannel     l_channel;
      Exception         l_exception;
      long              l_connect_start;
      long              l_connect_finish = 0;
      boolean           l_shown          = false;

      c_target ( String l_host ) {
      try {
